...
data.frame(
  ...
  dplyr::mutate(Video = cell_spec(rep("Link",length(dt_url)),"html",link=lecture_slides)) %>%
  dplyr::mutate(Slides = cell_spec(rep("Link",length(dt_url)),"html",link=lecture_videos)) %>%
