...
6. Save the xml and then point to it in your configuration file by adding the line: <p style='font-size:0.8em'>`<Value name = "adjust_elec_mix_subsidy">../gcam-core/input/addons/example_adjust_electricity_constraint.xml</Value>`</p>
</p>
